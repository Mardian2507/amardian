    ...
    <div className="w-full overflow-hidden">
      <div className="w-screen h-[50vh] relative">
        ...
        <div className="inset-center max-w-[1240px] w-full text-white z-10 p-2">
          <h2 className="py-2 flex justify-center">Moz Tracker</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid gap-8 py-8">
        <div className="col-span-4">
          <p>Project</p>
          <h2>Overview</h2>
          <Link href="https://github.com/Mardian2507/MozTracker">
          ...
          <Link href="https://moztracker.web.app">
          ...
          <div className="p-2">
            ...
            <div className="text-sm text-secondary/90 dark:text-light/70 grid grid-cols-4">
              <p className="py-2 flex items-center justify-center">
                <TechIcon className="pr-1 -mt-2" /> HTML
              </p>
              <p className="py-2 flex items-center justify-center">
                <TechIcon className="pr-1 -mt-2" /> CSS
              </p>
              <p className="py-2 flex items-center justify-center">
                <TechIcon className="pr-1 -mt-2" /> Javascript
              </p>
              <p className="py-2 flex items-center justify-center">
                <TechIcon className="pr-1 -mt-2" /> Bootstrap
              </p>
            </div>
          </div>
        </div>
